...
%nonassoc T_else
%start Start
%type<data> arith_exp term constant
...
assign_stmt : T_identifier T_assignOP arith_exp {
                                                    insert("Identifier", $<data>1, @1.first_line, strlen($<data>1), $3);
                                                }
             | T_identifier T_assignOP T_minus arith_exp{
                    char temp[100] = "-";
                    strcat(temp, $4);
                    insert("Identifier", $<data>1, @1.first_line, strlen($<data>1), temp);
             }
            | T_identifier T_assignOP bool_exp {insert("Identifier", $<data>1, @1.first_line, strlen($<data>1), "null");}
            | T_identifier  T_assignOP func_call {insert("Identifier", $<data>1, @1.first_line, strlen($<data>1), "null");}
            | T_identifier T_assignOP T_openBracket list_elements T_closeBracket {insert("List identifier", $<data>1, @1.first_line, strlen($<data>1), "null");}
			| T_identifier T_assignOP T_range {insert("List identifier", $<data>1, @1.first_line, strlen($<data>1), "null");} T_openParanthesis range_args T_closeParanthesis ;
...
func_def : T_def T_identifier {insert("Func_Name", $<data>2, @2.first_line, strlen($<data>2), "null");} T_openParanthesis{flag = 1; func_no++;} param T_closeParanthesis T_colon start_suite

func_call : T_identifier {insert("Func_Name", $<data>1, @1.first_line, strlen($<data>1), "null");} T_openParanthesis list_elements T_closeParanthesis

range_args : T_number T_comma T_number T_comma T_number {insert("Constant", $<data>1, @1.first_line, strlen($<data>1), "null"); insert("Constant", $<data>3, @3.first_line, strlen($<data>3), "null"); insert("Constant", $<data>5, @5.first_line, strlen($<data>5), "null");}
		   | T_number T_comma T_number {insert("Constant", $<data>1, @1.first_line, strlen($<data>1), "null"); insert("Constant", $<data>3, @3.first_line, strlen($<data>3), "null");}
		   | T_number {insert("Constant", $<data>1, @1.first_line, strlen($<data>1), "null");};
...
param : T_identifier {insert("Identifier", $<data>1, @1.first_line, strlen($<data>1), "null");} params | ;

params : T_comma T_identifier {insert("Identifier", $<data>2, @1.first_line, strlen($<data>2), "null");} params | ;

list_element : T_comma term list_element | ;

list_elements : T_identifier {insert("Identifier", $<data>1, @1.first_line, strlen($<data>1), "null");} list_element | T_number {insert("Constant", $<data>1, @1.first_line, strlen($<data>1), "null");} list_element | T_string {insert("Constant", $<data>1, @1.first_line, strlen($<data>1), "null");} list_element |
